...
function ProductCard({ xs, sm, md, lg, xl, xxl, data }) {
  return (
      ...
      <Link to={`/product/item/1`}>
        ...
        >
          ...
          <div className="flex  flex-wrap mt-2">
            <span className="size-7 bg-red-300  rounded-full"></span>
          </div>
          <div className="flex justify-between items-center mt-2">
            <span className="text-gray-600 text-red-500 font-bold">12.99d</span>
